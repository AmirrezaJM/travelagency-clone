...
const Hero = () => {
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row  border-2 border-pink-300">
      {/* RIGHT */}
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          we want to be on each other of your journeys seeking the 
          satisfactions of seeing the incrorruptions beatu of nature. We 
        ...
        <div className="mt-11 flex flex-wrap gap-5">
          <div className="flex items-center gap-2">
            {Array(5).fill(1).map((_,index) => {
              return (
                <Image src="/star.svg" key={index} alt="star" />
              );
            })}
          </div>
          ...
          <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
            <div className="flex flex-col">
              ...
              <div className="flexBetween">
                ...
                <p className="bold-20 text-white">Aguas cellientes</p>
              </div>
              {/*  */}
              <div className="flexBetween">
                <div className="flex flex-col">
                  <p className="regular-16 block text-gray-20">Distance</p>
                  <p className="bold-20 text-white">178.28 ml</p>
                </div>
                <div className="flex flex-col">
                  <p className="regular-16 block text-gray-20">Elavation</p>
